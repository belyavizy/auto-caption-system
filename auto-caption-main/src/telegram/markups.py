...
btn_show_obs = KeyboardButton("Показать OBS config")
btn_template = KeyboardButton("Выбрать шаблон титра 🖼")
...
main_menu.add(btn_template)
main_menu.add(btn_obs, btn_show_obs)
